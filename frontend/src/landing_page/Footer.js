        ...
        <footer style={{ backgroundColor: "rgb(250,250,250)" }}>
            <div className='container border-top mt-5'>
                <div className='row mt-5'>
                    ...
                    <div className='col'>
                        <p>Support</p>
                        <a href=""className='text-muted'style={{textDecoration:"none",color:"black"}} >Contact us</a><br />
                        ...
                        <a href=""className='text-muted'style={{textDecoration:"none",color:"black"}}>List of charges</a><br />
                        <a href=""className='text-muted'style={{textDecoration:"none",color:"black"}}>Downloads & resources</a><br />
                        <a href=""className='text-muted'style={{textDecoration:"none",color:"black"}}>Videos</a><br />
                        <a href=""className='text-muted'style={{textDecoration:"none",color:"black"}}>Market overview</a><br />
                        <a href=""className='text-muted'style={{textDecoration:"none",color:"black"}}>How to file a complaint?</a><br />
                        <a href=""className='text-muted'style={{textDecoration:"none",color:"black"}}>Status of your complaints</a><br />
                    </div>
                    <div className='col'>
                        <p>Account</p>
